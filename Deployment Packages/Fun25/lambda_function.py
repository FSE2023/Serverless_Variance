...
bucket_name = "bucketwendycyn"
#file_names=["240K.wav","480K.wav","1020K.wav","output_graph.pbmm"]
file_names=["output_graph1.pbmm", "data_smoke_test_LDC93S1.wav"]
...
model_path = '/tmp/output_graph1.pbmm'
print('Loading model from file {}'.format(model_path))
model_load_start = timer()
ds = Model('/tmp/output_graph1.pbmm')#, args.beam_width)
...
#    print("This is main")
#    #main()
# event1={"batch_size":5,"file_name":"data_smoke_test_LDC93S1.wav"}
