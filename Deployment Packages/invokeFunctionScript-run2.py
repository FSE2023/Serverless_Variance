...
if __name__ == "__main__":
    ...
    event_files =["input/fun20_input.json","input/fun29_input.json","input/fun54_input.json","input/fun55_input.json","input/fun56_input.json","input/fun57_input.json","input/fun60_input.json"]
